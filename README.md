...
```
 python visionai_data_format/bdd_to_vai.py -bdd_src_file /path/bdd.json -vai_dest_folder /path_for_visionai_root_folder  --sensor camera1 --uri_root https://azuresorate/container1
